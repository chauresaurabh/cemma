...
if($row['UserClass']==2)
    echo "<tr ><th colspan=2 BGCOLOR='#B3E0FF'>Class: Cemma Staff</th></tr>";
if($row['UserClass']==3)
    echo "<tr ><th colspan=2 BGCOLOR='#B3E0FF'>Class: Super User</th></tr>";
...
//  echo "<tr  >";
  ...
  echo "<tr>";
  echo "<th>Account Number</th><td width='40%'>" . $row['AccountNum'] . "</td>";
  echo "</tr>";

  echo "<tr>";
  echo "<th>First Name</th><td width='40%'>" . $row['FirstName'] . "</td>";
  echo "</tr>";

  echo "<tr>";
  echo "<th>Last Name</th><td width='40%' >" . $row['LastName'] . "</td>";
  echo "</tr>";
  ...
  echo "<tr>";
  echo "<th>USC ID</th><td width='40%'>" . $row['uscid'] . "</td>";
  echo "</tr>";
  ...
  echo "<tr>";
  echo "<th>Grad Year</th><td width='40%'>" . $row['GradYear'] . "</td>";
  echo "</tr>";

  if($row['ResponseEmail']=='Updated'){
  echo "<tr>";
  echo "<th>Status</th><td width='40%'> <font color='green'>" . $row['ResponseEmail'] . "</font></td>";
  echo "</tr>";
  }else{
  echo "<tr>";
  echo "<th>Status</th><td width='40%'> <font color='red'>" . $row['ResponseEmail'] . "</font></td>";
  echo "</tr>";
  }
  echo "<tr>";
  echo "<th>Field of Interest</th><td width='40%'>" . $row['FieldofInterest'] . "</td>";
  echo "</tr>";
  ...
  echo "<tr>";
  echo "<th>Last Status Update</th><td width='40%'>" . $mm."-".$dd."-".$yy . "</td>";
  echo "</tr>";
  ...
  echo "<tr>";
  echo "<th>Member Since</th><td width='40%'>" . $mm."-".$dd."-".$yy  . "</td>";
  echo "</tr>";
  ...
  echo "<tr>";
  echo "<th>Last Email Sent On</th><td width='40%'>" . $mm."-".$dd."-".$yy. "</td>";
  echo "</tr>";
