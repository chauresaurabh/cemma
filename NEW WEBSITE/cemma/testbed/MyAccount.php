...
//echo "	<script language='javascript'>alert('hi'); </script> ";
		...
		if($_GET['submit_mode'] != 'add'){
			...
			$mode = "Update";
	//		echo "<script language='javascript'>alert('hi'); advancePayment();</script>";
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 ...
 else
 {
	...
	//  echo "t: ".$check[0]." ".$check[1]." ".$check[2]." ";
...
$name1='Ameya';
	...
	$emaillist[$totalemailcount]=$row33['Email'];
	//echo "$i ".$emailid;
//	echo "\n";
	$totalemailcount++;
	}
	$jj=0;
	echo "<a href='mailto:";
	while($jj<=$totalemailcount) //$totalemailcount
	{
	if ($jj==$totalemailcount)
		{
...
// try end
		?>
                 ...
                 <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      <td class="t-top"><div class="title2"><?php echo (($_GET['submit_mode'] == 'add') ? 'Add ': 'Edit ');?>Details</div></td>
                    </tr>
                    <tr>
                      <td class="t-mid"><br />
                        <br />
                        <form id="myForm" name="myForm" method="post" action="MyAccount.php?id=<?=$_GET['id']?>&submit_mode=<?php echo $_GET['submit_mode'];?>">
                        <input type="hidden" id="Manager_ID" name="Manager_ID" value="<? echo $_SESSION['mid'] ?>" />
                          <table class="content" align="center" width="450" border = "0">
							...
							<tr class="Trow">
                              ...
                              <td><input type="text" size="30" name="Name" <?php echo (($_GET['submit_mode'] == 'add') ? '': 'readonly="true"');?> class="text"  value="<?=$row['Name']?>"></td>
                            </tr>
							...
							<tr class="Trow">
                              ...
                              <td>Building:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" class="text"  maxlength = "15" size = "15" name="Building" style = "width: 20mm"  value='<?=$row['Building']?>'>&nbsp; 
							 </tr>
							 <tr class="Trow">
							 <td></td>
							 <td>
							  Mail Code: &nbsp; &nbsp;<input type="text" class="text"  maxlength = "15" size = "15" name="EmailCode" style = "width: 20mm"  value='<?=$row['EmailCode']?>'>
							  </td>
							</tr>
							<tr class="Trow">
                              <td>US Mail Address: </td>
							...
							<tr class="Trow">
                              <td>Zip: *</td>
                              <td><!--<input type="text" size="30" name="Zip"  class="text" value="<?=$row['Zip']?>">
                            ...
                            <!-- <td><?=$enrolledPayments?></td>  --> 
							  ...
							  <td> <input type="checkbox" name="Payment[]" id="Payment" value="Regular" <? echo $check[0]; ?> />&nbsp; Regular
						  ...
						  <input type="hidden" name = "HiddenInstSelected">
							...
							<tr class="Trow">
                              <td>Activated: *</td>
                              <td><input type="radio" name="Activated" value="1" checked = "checked">Activated
								  <input type="radio" name="Activated" value="0">Not Activated</td>
                            </tr>
