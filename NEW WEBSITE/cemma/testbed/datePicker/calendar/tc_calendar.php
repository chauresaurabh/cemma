...
if((defined("L_LANG") && L_LANG != "en_US" && L_LANG != "L_LANG") || isset($language) && $language != "en_US") include_once(DOCUMENT_ROOT."datePicker/lang/calendar.".(isset($language) ? $language : L_LANG).".php");
include_once("lang/localization.lib.php");

if(file_exists("datePicker/calendar/calendar.js"))
{
?>
<script type="text/javascript" src="datePicker/calendar/calendar.js"></script>
<?php
}
