...
//
  ...
  ############################
     ...
     if($_cal_event->freq == 0) {
        ...
        (
         (
           ...
           ###################
           (
             ($_cal_event->freq == 3 && !ereg("[0-9]",$_cal_event->byday)
                  &&
           ...
           $_cal_event->freq == 2
               ...
               strpos($_cal_event->byday,",") === false && ereg("[0-9]",$_cal_event->byday)
     ...
     list($null,$null,$_cal_form->defaults['repeat_on_wday']) = split(" ", $byday);
