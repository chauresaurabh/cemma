...
if(!@constant("_CAL_NO_ADV_")) {
   ...
   echo("<br>");
   echo("<div align='left' style='font-size: 9px;'><a
    href='http://www.extrosoft.com' class='"._CAL_CSS_ULINE_."'
    style='color: #000; font-weight: 400;' 
    target='_new'><b>Thyme ". _THYME_VER_ ." ". (_ex_valid_license_key() ? "" : " - Trial") ."</b></a>
    &copy; 2007 eXtrovert Software LLC. All rights reserved.</div>");
