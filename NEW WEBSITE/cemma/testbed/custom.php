					...
					<td class="body_resize">
						<table border="0" cellpadding="0" cellspacing="0" align="left">
							<tr>
								<td>
									<h2 class="Our">
										<img src="images/h2_servises.gif" style="margin-right: 10px; vertical-align: middle">Manage Archived Customers
									</h2> 
													...
													<table width="90%" border="0" cellpadding="5" cellspacing="0">
														...
														mysql_query($sql13) or die("An error has ocured in query11: " .mysql_error (). ":" .mysql_errno ());	
															echo "Customer deleted";
																...
																$sql13 = "SELECT * FROM Customer where Activated = 1 AND ( Name like '".$usersa."%' OR Name like '".$usersb."%' ) order by Name ";
 									...
 									<td width="50">Name</td>
										...
										<td width="200" >Email</td>
																			...
																			<tr class="Trow" id="datarow<? echo $currentRowNum; ?>">
                                                                                ...
                                                                                <a
																					href="editCustomer.php?id=<?=$row['Customer_ID']?>">
                                                                                    <? }?>
																				...
																				<td align="center" valign="top">
                                                                                <? if($row['UserName']!='John'){?>
 <!-- <a  href="custom.php?deleteCustomer=1&id=<?=$row['Customer_ID']?>"> -->
...
function deleteCustomer(customerId, usera){
		...
		if (value == true) {
			 window.location = "custom.php?deleteCustomer=1&id="+customerId+"&usersa="+res.toLowerCase()+"&usersb="+res;
 		}  
}

function redirect(usera) {
	window.location = "custom.php?usersa="+usera+"&usersb="+usera.toUpperCase();
}
