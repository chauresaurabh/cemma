...
//	alert("alert");
document.getElementById("alert").innerHTML = "Instrument Type has been updated successfully";
...
//echo "ppppo".$row222['Email'];
		?>
                 ...
                 <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      <td class="t-top"><div class="title2"><?php //echo (($_GET['submit_mode'] == 'add') ? 'Add ': 'Edit ');?> Instrument Type Details</div></td>
                    </tr>
                    <tr>
                      <td class="t-mid"><br />
                        <br />
                        <form id="myForm" name="myForm" method="post" action="modify_instrumentType.php?id=<?=$InstrumentTypeNumber?>&submit=true">
                        <input type="hidden" id="Manager_ID" name="Manager_ID" value=""/>
                          <table class="content" align="center" width="450" border = "0">
							...
							<tr class="Trow">
                              <td width = "40%">*Type: </td>
                              <td><input type="text" size="30" name="typename" id="typename" class="text"  value="<?=$row['Type']?>" /></td>
                            </tr>
...
<!-- <input type="submit" value="Submit" align="center"> -->
		...
		<!-- hiiden link to addcustomer()--><tr> <td></td><td><a href = "javascript: tp()"></a></td></tr>
                    ...
                    <tr>
                      <td class="t-bot2"><a href = "javascript:submitclicked()">Modify Instrument Type</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="InstrumentTypes.php">Return</a></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
