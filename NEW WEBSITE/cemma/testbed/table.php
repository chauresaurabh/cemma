      ...
      <td>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            ...
            <tr><td class="t-mid">
              ...
              <table align="center" cellpadding="0" cellspacing="0" border="0" class="table1">
                <tbody>
                  <tr bgcolor="#F4F4F4" align="center">
                    <td width="40" onClick="javascript:showRecords(1, 1, 0)">Date</td>
                    <td width="40" onClick="javascript:showRecords(1, 2, 0)">Quantity</td>
                    <td width="100" onClick="javascript:showRecords(1, 3, 0)">Instrument</td>
                    <td width="40" onClick="javascript:showRecords(1, 4, 0)">Operator</td>
                    <td width="40" width="60" onClick="javascript:showRecords(1, 5, 0 )">With Operator?</td>
                    <td width="40" onClick="javascript:showRecords(1, 6, 0)">Total</td>
                    <td width="40" onClick="javascript:showRecords(1, 7, 0)">Invoice No</td>
                    <td width="30"> Edit </td>
                    <td width="35">Remove</td>
                  </tr>
                  <tr align="center">
                    <td>07/30/09</td>
                    <td>5.00</td>
                    ...
                    <td><a href="javascript:editRecord('557','3','2009-08-05')"><img src="images/edit_icon.png" alt="Edit" width="13" height="13" border="0" class="tableimg" /></a><a href="javascript:editRecord('558','3','2009-08-05')"></a></td>
                    <td class="tableimg"><a href="javascript:removeRecord('558')"></a><a href="javascript:removeRecord('557')"><img src="images/trash_icon.gif" alt="Remove" width="10" border="0" /></a></td>
                  </tr>
                  <tr align="center">
                    <td>07/30/09</td>
                    <td>1.30</td>
                    ...
                    <td>91.00</td>
                    <td><a href="view_invoice2.php?invoiceno=3&Gdate=2009-08-05&name=Chongwu Zhou&pagenum=1" target="_blank">MO 10/3</a></td>
                    <td><a href="javascript:editRecord('557','3','2009-08-05')"><img src="images/edit_icon.png" alt="Edit" width="13" height="13" border="0" class="tableimg"></a></td>
                    <td class="tableimg"><a href="javascript:removeRecord('557')"><img src="images/trash_icon.gif" alt="Remove" width="10" border="0"></a></td>
                  </tr>
                  <tr align="center">
                    <td>07/24/09</td>
                    <td>1.00</td>
                  ...
                  <tr align="center">
                    ...
                    <td><a href="javascript:removeRecord('508')"><img src="images/trash_icon.gif" border="0" alt="Remove"></a></td>
                  </tr>
                </tbody>
              </table>
