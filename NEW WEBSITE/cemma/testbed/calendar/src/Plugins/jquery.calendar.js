...
; (function($) {
	...
	if (!cemmaDateFormat || typeof (cemmaDateFormat) != "function") {
        var cemmaDateFormat = function(format) {
            var o = {
                "M+": this.getMonth() + 1,
                "d+": this.getDate(),
				//cemma changes
    ...
    $.fn.bcalendar = function(option) {
		...
		//cemma change - added ${description}
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\"><DT style=\"BACKGROUND-COLOR:${bgcolor2}\">${starttime} - ${endtime} ${icon}</DT><DD><SPAN>${content}<br/>${description}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; BORDER-RIGHT-COLOR: ${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BORDER-TOP-COLOR:${bdcolor}; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb2>&nbsp;</DIV></DIV>";
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            //cemma changes - add allDayEvents in parameter
			BuildDayScollEventContainer(html, days, scollDayEvents, allDayEvents);
		...
		function BuildWT(ht, dayarrs, events, dMax) {
            //1:cemma changes
			if($("#hiddencurrentuserid").val()=='John'){
            	ht.push("<tr>", "<th width=\"60\" rowspan=\"3\"><input type='button' style='white-space: normal;font-size:10px;' value='Weekly Mail' onClick='sendWeeklymail(\"",dateFormat.call(dayarrs[0].date, i18n.xgcalendar.dateformat.fulldayvalue),"\",\"",dateFormat.call(dayarrs[6].date, i18n.xgcalendar.dateformat.fulldayvalue),"\",\"",$("#InstrName").val(),"\");'></input></th>");
			} else {
            ...
            if (dMax == 0) {
                ...
                for (var i = 0; i < dayarrs.length; i++) {
					if(option.readonly) {
						ht.push("<td style='text-align: center;' class=\"st-c st-s\"", " ch='qkadd' abbr='", dateFormat.call(dayarrs[i].date, "yyyy-M-d"), "' axis='00:00'></td>");
					} else {
                    	ht.push("<td style='text-align: center;' class=\"st-c st-s\"", " ch='qkadd' abbr='", dateFormat.call(dayarrs[i].date, "yyyy-M-d"), "' axis='00:00'><input type='button' style='white-space: normal;font-size:10px;' value='",$("#hiddencurrentuserid").val()=='John'?"Daily Mail or Create Event":"Create Event","'></input></td>");
					}
                }
                ht.push("</tr>");
            }
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events, allDayEvents) {
            //1:
			//-- Cemma changes--
            /*ht.push("<tr>");
            ...
            for (var i = 0; i < 24; i++) {
				...
				if(i>=9 && i<=17){
					...
					ht.push("<div class=\"tg-dualmarker1 offpeak-hours\"></div>");
					ht.push("<div class=\"tg-dualmarker1 offpeak-hours\"></div>");
				}
            }
			...
			*/
            ...
            var l = dayarrs.length;
            for (var i = 0; i < l; i++) {
				//check if any of the events for the day is a day long event
				//a day long event has color 20
				var dayLongEvent = false;
				var ev = allDayEvents[i];
				
				if(ev.length>0) {
					for (var w = 0; w < ev.length; w++) {
						if(ev[w].event[7] && ev[w].event[7] == 20) {
							dayLongEvent = true;
							break;
						}
					}
				...
				//-- Cemma changes--
				ht.push("<div id=\"tgspanningwrapper\" class=\"tg-spanningwrapper\" style=\"z-index:0;\"><div style=\"z-index:0; font-size: 20px\" class=\"tg-hourmarkers\">");
			
				for (var o = 0; o < 24; o++) {
					if(dayLongEvent) {
						ht.push("<div class=\"tg-dualmarker1 offpeak-hours\" style=\"z-index:0;\"></div>");
						ht.push("<div class=\"tg-dualmarker1 offpeak-hours\" style=\"z-index:0;\"></div>");
					} else {
						if(i>4){
							ht.push("<div class=\"tg-dualmarker1 offpeak-hours\" style=\"z-index:0;\"></div>");
							...
							if(o>8 && o<16){
								ht.push("<div class=\"tg-dualmarker\" style=\"z-index:0;\"></div>");
								ht.push("<div class=\"tg-dualmarker\" style=\"z-index:0;\"></div>");
							} else {
								if(o==16) {
									ht.push("<div class=\"tg-dualmarker1\" style=\"z-index:0;\"></div>");
									ht.push("<div class=\"tg-dualmarker1 offpeak-hours\" style=\"z-index:0;\"></div>");
								} else {
									ht.push("<div class=\"tg-dualmarker1 offpeak-hours\" style=\"z-index:0;\"></div>");
									ht.push("<div class=\"tg-dualmarker1 offpeak-hours\" style=\"z-index:0;\"></div>");
        ...
        function getTitle(event) {			
            ...
            timeshow = cemmaDateFormat.call(event[2], startformat) + " - " + cemmaDateFormat.call(event[3], endformat);
        ...
        function BuildDayEvent(theme, e, index) {
			...
			var sP;
			if(spm==true){
	            sP = gP(e.st.hour+12, e.st.minute);
			} else {
			    sP = gP(e.st.hour, e.st.minute);
			}
            var eP;
			if(epm==true){
				eP = gP(e.et.hour+12, e.et.minute);
			} else {
				eP = gP(e.et.hour, e.et.minute);
			}
            p.top = sP + "px";
            p.left = (e.left * 100) + "%";
            p.width = (e.aQ * 100) + "%";
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            p.data = e.event.join("$");
			//cemma changes - added white-space to style
            var sp = "<span style=\"cursor: pointer; white-space:normal;\">${content}</span>";
            ...
            if (option.url && option.url != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {//function(datastr) {									
                        ...
                        if (data != null && data.error != null) {
                            if (option.onRequestDataError) {
                                option.onRequestDataError(1, data.error);
                            }
                        }
                        else {
                    ...
                    error: function(data) {	
						try {							
                            if (option.onRequestDataError) {
                                option.onRequestDataError(1, data.response);
                            } else {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;"></div></div>'+
						//cemma changes
						'<div class="textbox-fill-mid">'+
						'<div id="bbit-cs-email" title="' + i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;">'+
						'</div>'+
						'</div>'+
						'<div class="textbox-fill-mid"><div id="bbit-cs-advisor" class="textbox-fill-div"></div></div>'+
						'<div class="textbox-fill-mid"><div id="bbit-cs-telephone" class="textbox-fill-div"></div></div>'+
						'</div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-instrument"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk">'
            	+ i18n.xgcalendar.i_delete + '</span> ]&nbsp; <SPAN id="bbit-cs-editLink" class="lk">'
                    ...
                    if (data[4] != 1) {
                        ss.push(",", cemmaDateFormat.call(data[2], "HH:mm"));
                    }

                    if (iscos) {
                        ss.push(" - ", cemmaDateFormat.call(data[3], i18n.xgcalendar.dateformat.Md3), " (", __WDAY[data[3].getDay()], ")");
                        if (data[4] != 1) {
                            ss.push(",", cemmaDateFormat.call(data[3], "HH:mm"));
                        }
                    }
					
					var ts = $("#bbit-cs-buddle-timeshow").html(ss.join(""));
					if(data[11]=="none"){
						$("#bbit-cs-buddle-instrument").html("Instrument: Common Event");
					} else {
						$("#bbit-cs-buddle-instrument").html("Instrument: "+data[11]);
					}
					//cemma changes
                    $("#bbit-cs-what").html(data[1]);
					$("#bbit-cs-email").html(data[12]);
					$("#bbit-cs-advisor").html("Advisor: " +data[13]);
					$("#bbit-cs-telephone").html("Telephone: "+data[14]);
					
					$("#bbit-cs-email").click(function(e) {
						var url="calendar/EmailCustomer.php?email="+$("#bbit-cs-email").html();
						OpenModelWindow(url,{width:500, height:300, caption: "Mail Customer", onclose:function(){ CloseModelWindow();
						}});
						$("#bbit-cs-buddle").css("visibility", "hidden");
						return false;
					});
                    ...
                    bud.data("cdata", data);
					//cemma changes - minus 100 from top
                    bud.css({ "visibility": "visible", left: pos.left, top: pos.top-100 });
        ...
        function quickadd(start, end, isallday, pos) {
			...
			/*<input id="bbit-cal-what" class="textbox-fill-input" value=""/>*/
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid">'+document.getElementById("hiddencurrentuserid").value+'</div></div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-start-edit" type="hidden"/><input id="bbit-cal-end-edit" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
                ...
                calbutton.click(function(e) {
					...
					if(option.instrument==""){
						 option.instrument="none";
					}
                    if (option.isloading) {
                        return false;
                    }
                    option.isloading = true;
                    var what = /*$("#bbit-cal-what").val()*/document.getElementById("hiddencurrentuserid").value;
                ...
                lbtn.click(function(e) {
                    if (!option.EditCmdhandler) {
                        ...
                        if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                            option.EditCmdhandler.call(this, ['0', document.getElementById("hiddencurrentuserid").value, $("#bbit-cal-start-edit").val(), $("#bbit-cal-end-edit").val(), $("#bbit-cal-allday").val()]);
                        }
                        $("#bbit-cal-buddle").css("visibility", "hidden");
                        realsedragevent();
                    }
            ...
            var calwhat = /*$("#bbit-cal-what").val("")*/document.getElementById("hiddencurrentuserid").value;
            ...
            $("#bbit-cal-start-edit").val(dateFormat.call(start, i18n.xgcalendar.dateformat.dbfulldayformat + " HH:mm:ss"));
            $("#bbit-cal-end-edit").val(dateFormat.call(end, i18n.xgcalendar.dateformat.dbfulldayformat + " HH:mm:ss"));
            ...
            if (_dragdata) {
                ...
                switch (d.type) {
                    ...
                    case 3: //month view					
                        ...
                        if(createEvent==1 && ($("#hiddencurrentuserid").val()=='John')){
							$.alerts.okButton="Email";  
                			$.alerts.cancelButton="Event";  
                			hiConfirm("You want to send an Email or create a day long event?", 'Confirm',function(r){
								if(r){
								
									var eurl="EmailCustomers.php?start="+dateFormat.call(start, i18n.xgcalendar.dateformat.fulldayvalue)+"&instrument="+$("#InstrName").val();
									...
									if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
										option.EditCmdhandler.call(this, ['0', document.getElementById("hiddencurrentuserid").value, dateFormat.call(start, i18n.xgcalendar.dateformat.dbfulldayformat + " HH:mm:ss"), dateFormat.call(end, i18n.xgcalendar.dateformat.dbfulldayformat + " HH:mm:ss"), 0]);
									}
        ...
        var c = {
            ...
            lce: function(instrument) {
                if (instrument == option.instrument) {
                    return;
                }
                clearcontainer();
	...
	/**
     * @description {Method} loadCalendarEvents : Loads events for the selected calendar.
     * @param {String} instrument. 
     */
    $.fn.loadCalendarEvents = function(instrument) {
        return this.each(function() {
            if (this.bcal) {
				this.bcal.lce(instrument);
            }
        })
    };
