...
/*
include "supercali/includes/start2.php";
$canview = false;
//if no access, then kick them out!
echo 'superview:'.$superview;
if (!$superview) {
	mysql_close($link);
...
echo 'canview:'.$canview;
echo 'script:'.$script;
if (($canview == true)&& $script) {
	include "supercali/modules/".$script;
} else {
	include "supercali/includes/header.php";
	include "supercali/includes/footer.php";
}
*/
?>
										...
										<table cellpadding="0" cellspacing="0" border="0" width="693px">
											<tr>
												<td>
													<div id="calback"> 
														<div id="calendar">
															<iframe frameborder='0' src="supercali/index.php" width="800px" height="900px">
