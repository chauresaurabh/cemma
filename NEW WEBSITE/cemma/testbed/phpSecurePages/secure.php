...
$cfgServerHost = 'db1661.perfora.net';      // MySQL hostname
$cfgServerPort = '';						// MySQL port - leave blank for default port
$cfgServerUser = 'dbo260244667';            // MySQL user
$cfgServerPassword = 'curu11i';            // MySQL password

$cfgDbDatabase = 'db260244667';			// MySQL database name containing phpSecurePages table
$cfgDbTableUsers = 'Customer';         // MySQL table name containing phpSecurePages user fields
$cfgDbLoginfield = 'Uname';                // MySQL field name containing login word
$cfgDbPasswordfield = 'Passwd';         // MySQL field name containing password
$cfgDbUserLevelfield = 'Role_ID';       // MySQL field name containing user level
...
$cfgDbUserIDfield = 'Customer_ID';        // MySQL field name containing user identification
