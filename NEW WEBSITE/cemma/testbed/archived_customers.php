													...
													<table width="90%" border="0" cellpadding="5" cellspacing="0">
														...
														mysql_query($sql13) or die("An error has occurred in query11: " .mysql_error (). ":" .mysql_errno ());	
															echo "Customer deleted";
																...
																$sql13 = "SELECT * FROM Customer where Activated = 0 AND ( Name like '".$usersa."%' OR Name like '".$usersb."%' ) order by Name ";
 									...
 									<td width="50">Name</td>
										...
										<td width="200" >Email</td>
																			...
																			<tr class="Trow" id="datarow<? echo $currentRowNum; ?>">
                                                                                ...
                                                                                <a
																					href="editCustomer.php?mode=Archived&id=<?=$row['Customer_ID']?>">
                                                                                    <? }?>
...
function deleteCustomer(customerId, usera){
		...
		if (value == true) {
			 window.location = "archived_customers.php?deleteCustomer=1&id="+customerId+"&usersa="+res.toLowerCase()+"&usersb="+res;
 		}  
}

function redirect(usera) {
	window.location = "archived_customers.php?usersa="+usera+"&usersb="+usera.toUpperCase();
}
