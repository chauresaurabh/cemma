 ...
 ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center"><tr><td class="body_resize">
       ...
       <td>
        ...
        <h2 class = "Our"> Service Category</h2>
...
//mysql_close($connection);
            ...
            <div class="title">Instrument Type Details</div>
              ...
              <table align="center" cellpadding="0" cellspacing="0" border="0" class="Tcontent">
                <tbody>
                  <tr bgcolor="#F4F4F4" align="center" class="Ttitle">
                    <td width="30" >No</td>
                    <td width="350" >Service Category ID</td>
					<td width="350" >Service Category</td>
	...
	?>
				  ...
				  <tr  class="Trow">
					...
					<td align="center" valign="top"><?=$row['TypeNumber']?></td>
                    <td align="center" valign="top"><?=$row['Type']?></td> 
                    <td align="center" valign="top">
					

						<a href="modify_instrumentType.php?id=<?=$row['TypeNumber']?>"> 
						<img src="images/edit_icon.png" alt="Edit" width="13" height="13" border="0" class="tableimg" />
						</a>
					</td> 

                    <td align="center" valign="top">
						<a href="RemoveInstrumentType.php?id=<?=$row['TypeNumber']?>"> 
            ...
            <tr>
            	 ...
            	 <td class="t-bot2">
					 ...
					 <a href="AddInstrumentType.php?id=&submit_mode=add">New Type</a>&nbsp;&nbsp;
				</td>
            </tr>
        </table>
