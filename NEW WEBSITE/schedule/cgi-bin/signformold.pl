...
$db= DBI->connect($dsn, "dbo210021972", "XhYpxT5v");
	...
	print "</title>";
   	print "<body background=\"../_image/valtxtr.gif\">";
		...
		print "  <form method=post action=\"scheduleold.pl\" onsubmit=\"return CheckBeforeSubmit()\" name=\"newsign\">";
	...
	if($option ne "manual"){
		...
		print "        <td width=\"166\"> ";
		print "<select type=\"hidden\" name = \"InstrName\">\n";
		...
		print "<input type=\"hidden\" name=\"InstrName\" value = \"JEOL JEM-2100F\">";
		print "</form>";
	}
	print "</body>";
	print "</center></html>";
