...
$db= DBI->connect($dsn, "dbo210021972", "XhYpxT5v");
	...
	print "</br></br>";
	print "<tr><td><a href='http://cemma-usc.net/cemma/testbed/login.php'>";
	print "<input type='submit' value='Login' style='width:200px'></a></td> 
	 <td><a href='http://www.usc.edu/dept/CEMMA/account-set-up.htm'> 
	 <input type='submit' value='New User' style='width:200px'></a></td></tr>";
