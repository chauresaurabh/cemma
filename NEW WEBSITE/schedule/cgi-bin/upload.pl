...
$html=qq{
	<html>
<body>
<center><form action="../upload_file.php?username=$login" method="post" enctype="multipart/form-data">
...
<br />
<br />
<form action="../download_file.php?username=$login" method="post" enctype="multipart/form-data">
