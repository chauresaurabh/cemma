...
$filename = '../../cemma/invoice/invoice.xml';
...
$filename1 = '../../cemma/invoice/output_invoice.html';
...
print "<head><script type='text/javascript'>function display_invoice (item1) { var num1 = item1.parentNode.parentNode.cells[1].innerHTML; document.getElementById('number').value = num1; document.getElementById('form1').submit();	}</script> "

print "<body><p>" . "Invoice created successfully" . "</p>";
print "<br><a href='javascript:display_invoice($data->{header}->{number})'>Click here </a>to view the invoice.";
