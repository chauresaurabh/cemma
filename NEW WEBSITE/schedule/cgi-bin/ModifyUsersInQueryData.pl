...
#print "$field ";
	...
	{ # change admin himself
		my $ins = "update UsersInQuery set Passwd='$password', Class='$class', FirstName='$firstname', LastName='$lastname', Name='$firstname $lastname', Email='$email', Telephone='$tel', Dept='$dept', Advisor='$advisor', GradYear = $gradyear, GradTerm ='$gradterm', Position='$position', FieldofInterest='$field', Comments='$Comments' where UserName = '$login'";
		$db->do($ins);
