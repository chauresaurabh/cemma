...
if($spassword eq $passworddb)
{
	...
	print "<tr>";
	print "<td align=\"left\">";
	print "<font face=\"Arial\" color=\"#FFFFFF\" size=\"-1\"><b><i>User: $name</i></b></font>";
	print "</td>";
  	...
  	print "<td width=\"90\"><a href=\"modifyuser.php?SID=$sid&adminlogin=$login&option=manual\" target=\"response\">";
  	print "<img border=\"0\" src=\"../_image/manual.gif\" width=\"90\" height=\"36\" alt=\"View Schedule\"></a></td>";

	print "<td width=\"90\"><a href=\"upload.pl?SID=$sid&login=$login\" target=\"response\">";
  	print "<img border=\"0\" src=\"../_image/upload.jpg\" width=\"90\" height=\"36\" alt=\"View Schedule\"></a></td>";
	
	print "<td align=\"right\" valign=\"top\">";
	print "<a href=\"javascript:openWindow('changepassword.pl?SID=$sid&login=$login');\">"; 
