...
Modified by Jonathan Kelly for use on the CEMMA website.			
*********************************************************/
...
$type = 2;
$IP_FILE = 'ips.txt'; //Chmod to 777 
$COUNTER_FILE = 'counter.txt'; //Chmod to 777 
...
//Open Ip file, if !exist create one, and see if we have a match
if(!is_file('ips.txt')){
