...
# Dict for user info.
	...
	$sth = $db->prepare("select UserName, FirstName, LastName, Email, FieldofInterest from UsersInQuery");
	$sth->execute();
	$user_no = 0;
	...
	while(($UserName, $FirstName, $LastName, $Email, $FieldofInterest) = $sth->fetchrow_array) {
		$usersinquery{$LastName} = [$LastName, $FirstName, $Email, $FieldofInterest];
		$countusersinquery++;
	}
	...
	print "<div align=\"center\">\n";
  	print "<center>\n";
	print "<table border=\"3\" cellpadding=\"3\" cellspacing=\"3\" width=\"1000\">\n";
	print "<tr>\n";
		...
		print "<td width=\"230\"><b>Field of Interest</b></td>\n";
    	print "<td width=\"60\"><b>Modify</b></td>\n";
    	print "<td width=\"60\"><b>Delete</b></td>\n";
