...
if($spassword eq $passworddb)
{
	...
	print "<h3><a href=\"newinstr.pl?SID=$sid&adminlogin=$adminlogin\" target=\"response\">Add instrument</a></h3>";
...
#a undo	$sth->execute();
	...
	while(($instrNo, $instrName, $instrCan)=$sth->fetchrow_array)
	{
		...
		print "<td width=\"150\">";
		print "<a href=\"modifyinstr.pl?SID=$sid&adminlogin=$adminlogin&tag=$instrNo\">Display/Modify</a>";
          	print "</td>";
		print "<td width=\"80\">";          	
		print "<a href=\"delinstr.pl?SID=$sid&adminlogin=$adminlogin&tag=$instrNo\"> Delete</a>";
          	print "</td>";
		print "<td width=\"100\">";          	
		print "<a href=\"groupmail.pl?SID=$sid&adminlogin=$adminlogin&tag=$instrNo\">Email</a>";
          	print "</td>";
		print "</tr>";
		$user_no++;
	}
