...
if($password eq $passworddb)
{
 ...
 #  	print "<body background=\"../_image/valtxtr.gif\">";	
	...
	print "<frame name=\"option\" SRC=\"user_option1.pl?SID=$sid&login=$login\" scrolling=\"no\" noresize frameborder=0>\n";
	print "<frame name=\"response\" SRC=\"response1.pl\" noresize>\n";
	print "</frameset>\n";
#	print "</body>";
	print "</html>\n";
}
