...
if($spassword eq $passworddb)
{
	...
	s/ /%20/g;
	print "<head>";
	print "<meta http-equiv=\"refresh\"; CONTENT=\"10; url=signup.cgi?SID=$sid&login=$login&week=$offset&InstrName=$_\">";
	print "</head>";
	...
	if (($classadmin eq '2') && ($count > 4))
	{
		...
		print "<p>This page will refresh in 10 seconds automatically. </p>";
		print "</body>";
		print "</html>";
